...
describe('Formily boolean / date / multi-select / section / grid', () => {
  it('renders a boolean field as a Checkbox', async () => {
    ...
    const screen = await render(
      withProvider(<WorkRecordSchemaField schema={schema} />)
    )
  ...
  it('renders a date field as an HTML date input', async () => {
    ...
    await expect.element(screen.getByTestId('formily-date-day')).toBeVisible()
    const input = screen
      .getByTestId('formily-date-day')
