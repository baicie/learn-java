...
select concat('dict-item-', t.id, '-record-type-daily'), t.id, d.id,
...
select concat('dict-item-', t.id, '-record-type-fault'), t.id, d.id,
...
select concat('dict-item-', t.id, '-record-type-inspection'), t.id, d.id,
...
select concat('dict-item-', t.id, '-record-type-change'), t.id, d.id,
...
select concat('dict-item-', t.id, '-record-status-draft'), t.id, d.id,
...
select concat('dict-item-', t.id, '-record-status-done'), t.id, d.id,
...
select concat('dict-item-', t.id, '-record-status-archived'), t.id, d.id,
...
select concat('dict-item-', t.id, '-priority-p0'), t.id, d.id,
...
select concat('dict-item-', t.id, '-priority-p1'), t.id, d.id,
...
select concat('dict-item-', t.id, '-priority-p2'), t.id, d.id,
...
select concat('dict-item-', t.id, '-priority-p3'), t.id, d.id,
...
select concat('dict-item-', t.id, '-env-prod'), t.id, d.id,
...
select concat('dict-item-', t.id, '-env-staging'), t.id, d.id,
...
select concat('dict-item-', t.id, '-env-test'), t.id, d.id,
...
select concat('dict-item-', t.id, '-yes'), t.id, d.id,
...
select concat('dict-item-', t.id, '-no'), t.id, d.id,
       '否', 'no', null, null, null,
       true, true, 20, '{}'::jsonb, 'system'
from tenant t
join platform_dict_type d on d.tenant_id = t.id and d.dict_code = 'yes_no'
...
select concat('dict-item-', t.id, '-process-success'), t.id, d.id,
...
select concat('dict-item-', t.id, '-process-follow-up'), t.id, d.id,
