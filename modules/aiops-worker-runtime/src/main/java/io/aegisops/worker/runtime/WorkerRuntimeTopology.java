...
/**
 * Declares the background scheduling topology loaded into {@code aegisops-app}: a {@link
 * ThreadPoolTaskScheduler} that drives the {@link OutboxPoller#tick()} loop on the configured
 * {@link OutboxProperties#pollDelayMs()} interval.
 *
