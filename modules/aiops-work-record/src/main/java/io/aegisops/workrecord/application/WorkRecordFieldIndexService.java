 ...
 * </ul>
 *
 * <p>与 {@link WorkRecordTemplateApplicationService#saveSchema} 配合使用：SchemaService 负责规范化和抽取，
...
public class WorkRecordFieldIndexService {
   ...
   *
   * <p>对每个新创建 / 重新启用 / 软删除的字段写审计日志，action 取自 {@code work_record.field.create} / {@code
