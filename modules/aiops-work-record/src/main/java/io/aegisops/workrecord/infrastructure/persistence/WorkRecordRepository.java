...
public class WorkRecordRepository {
  ...
  private void appendInClause(
      StringBuilder where, List<Object> params, String column, List<String> values) {
  ...
  private void appendTimeRangeClause(
      StringBuilder where, List<Object> params, OffsetDateTime from, OffsetDateTime to) {
    if (from != null) {
  ...
  private void appendDynamicFilters(
      StringBuilder where, List<Object> params, List<DynamicFieldFilter> filters) {
  ...
  private long countWithFiltersInternal(String whereClause, Object[] params) {
    Long total =
        jdbc.queryForObject("select count(*) from wr_record " + whereClause, Long.class, params);
    return total == null ? 0L : total;
  }
  ...
  public List<WorkRecord> pageForExport(
      String tenantId,
      int maxRows,
      String templateId,
      List<String> status,
    ...
    return jdbc.query(
        "select id, tenant_id, template_id, title, status, owner_id, creator_id, record_time, "
            ...
            + "from wr_record "
            + where
            + " order by record_time desc, created_at desc limit ?",
        (rs, rowNum) -> mapRecord(rs),
        params.toArray());
  }

  public long countForExportUser(
      String tenantId,
      String userId,
      String templateId,
      List<String> status,
  ...
  public List<WorkRecord> pageForExportUser(
      String tenantId,
      String userId,
      int maxRows,
      String templateId,
