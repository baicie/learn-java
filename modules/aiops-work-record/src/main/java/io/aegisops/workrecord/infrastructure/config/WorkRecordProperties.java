 ...
 * 工作记录模块配置项。
 *
 * <p>通过 {@code aiops.work-record.export.max-rows} 绑定，默认 5000。允许运维在不重启 服务的前提下调整导出上限（受限于
 * application.yml reload 机制）。
 *
 * <p>本类属于基础底座，不携带业务规则；约束与执行由 {@link WorkRecordExportApplicationService} 强制。
 */
